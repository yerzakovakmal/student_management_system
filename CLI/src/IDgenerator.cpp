...
string IDgenerator::generateStudentID() {
    resetIfNewYear();
    ostringstream out;
    out << "S" << setw(2) << setfill('0') << currentYear
        << "-" << setw(4) << setfill('0') << ++studentCount;
    return out.str();
}
...
string IDgenerator::generateProfessorID() {
    resetIfNewYear();
    ostringstream out;
    out << "P" << setw(2) << setfill('0') << currentYear
        << "-" << setw(4) << setfill('0') << ++professorCount;
    return out.str();
}
...
string IDgenerator::generateAdminID() {
    resetIfNewYear();
    ostringstream out;
    out << "A" << setw(2) << setfill('0') << currentYear
        << "-" << setw(4) << setfill('0') << ++adminCount;
    return out.str();
}
